...
<script>
	$(function(){
		if(PCS && typeof PCS.runScriptForSlide === 'function'){
			PCS.runScriptForSlide(28, $('#multiplechoice'));
		}
...
<div class="description_container">
				<div class="description">
					...
					<p>Mulitple Choice gives different options for the learner to choose between for the correct answer. With this Multiple Choice interaction, only one answer can be correct. There are options for item feedback for choices within each question, as well as for completion of the interaction. This option of showing all the questions allows for all the questions to be presented at once and to be answered in any order.</p>
					...
					<p>Interaction type: multiple choice - show all of the questions.</p>
					<p>Description: The learner answers multiple-choice questions.</p>
				</div>	
