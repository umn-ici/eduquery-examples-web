...
var PCS = (function() {
	...
	var scriptsArr = new Array(
		...
		null, //7
		function($context){
			MultipleChoice.init($context, null);
			MultipleChoice.setMessage('win', 'You’ve learned a lot about the assessment process for participant-directed services and supports. If this exercise was difficult then you may want to go back and review this lesson before moving on.');
